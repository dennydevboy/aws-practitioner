...
export class ProductsService extends ApiService {
  ...
  getProductById(id: string): Observable<Product | null> {
    if (!this.endpointEnabled('bff')) {
      ...
      return this.http
        .get<Product[]>('https://kcdwh5ak1a.execute-api.us-east-1.amazonaws.com/dev/products')
        .pipe(
          map(
  ...
  getProducts(): Observable<Product[]> {
    if (!this.endpointEnabled('bff')) {
      ...
      return this.http.get<Product[]>('https://kcdwh5ak1a.execute-api.us-east-1.amazonaws.com/dev/products');
    }
